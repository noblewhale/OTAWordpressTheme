...
if (function_exists('add_theme_support'))
{
    ...
    add_image_size('tiny', 64, 64, true );
...
function create_post_type_html5()
{
    ...
    register_post_type('artist', // Register Custom Post Type
        array(
        'labels' => array(
            'name' => __('Artist Posts', 'html5blank'), // Rename these to suit
            'singular_name' => __('Artist Post', 'html5blank'),
            'add_new' => __('Add New', 'html5blank'),
            'add_new_item' => __('Add New Artist Post', 'html5blank'),
            'edit' => __('Edit', 'html5blank'),
            'edit_item' => __('Edit Artist Post', 'html5blank'),
            'new_item' => __('New Artist Post', 'html5blank'),
            'view' => __('View', 'html5blank'),
            'view_item' => __('View Artist Post', 'html5blank'),
            'search_items' => __('Search Artist Post', 'html5blank'),
